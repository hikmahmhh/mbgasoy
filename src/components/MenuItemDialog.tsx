        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input type="number" min={0} value={form.calories} onChange={(e) => setForm({ ...form, calories: Number(e.target.value) })} />
            </div>
            <div>
            ...
            <div>
              <Label>Lemak (g)</Label>
              <Input type="number" min={0} step={0.1} value={form.fat} onChange={(e) => setForm({ ...form, fat: Number(e.target.value) })} />
            </div>
            <div>
              <Label>Karbohidrat (g)</Label>
              <Input type="number" min={0} step={0.1} value={form.carbs} onChange={(e) => setForm({ ...form, carbs: Number(e.target.value) })} />
            </div>
          </div>
        </div>
        <DialogFooter>
